...
The public demo does not process real payments, passwords, or production customer data. Treat any secret, credential, private token, or real personal data committed here as a security incident.
...
- Affected page, component, dependency, or workflow.
...
- Confirmed dependency or configuration issues are prioritized before feature work.
...
- Findings that require modifying a user's local browser or device outside the application.
